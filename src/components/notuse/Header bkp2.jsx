  ...
  return (
    <header className="fixed top-8 left-1/2 -translate-x-1/2 z-50 w-full px-4">
      <nav
        ...
        rounded-3xl bg-white/90 border border-gray-200
        px-5 py-3 shadow-xl backdrop-blur-md"
      >
        {/* Logo */}
        ...
        <ul className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <li className="relative group">
            ...
            <div
              className="absolute left-1/2 top-full mt-4 w-[320px]
        ...
        <div className="rounded-3xl bg-white shadow-2xl p-6">
          <div className="flex flex-col gap-4 text-base font-medium">
            ...
            <Link
              ...
              rounded-2xl bg-[#0A8B41] hover:bg-[#087636] text-white px-5 py-3 font-medium"
            >
              Say hi <GoArrowUpRight />
            </Link>
